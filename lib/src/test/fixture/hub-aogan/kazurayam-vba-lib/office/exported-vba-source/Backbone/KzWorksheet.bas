...
Public Function KzCreateWorksheetInWorkbook(ByVal wb As Workbook, ByVal sheetName As String) As Boolean
    Dim flg As Boolean: flg = False
...
Public Function KzDeleteWorksheetInWorkbook(ByVal wb As Workbook, ByVal sheetName As String) As Boolean
    Dim ws As Worksheet
    Dim flg As Boolean: flg = False
    ...
    For Each ws In Worksheets
        ...
        End If
    Next ws
    KzDeleteWorksheetInWorkbook = flg
End Function
...
On Error GoTo ErrorHandler
    ...
    If KzIsWorksheetPresentInWorkbook(targetWorkbook, targetSheetName) Then
